...
md5sums=('feddebbe469ece55692ba761ae4ebd74')
...
package_python-asdf_wcs_schemas() {
    depends=('python>=3.9' 'python-asdf-standard>=1.1.0' 'python-asdf_transform_schemas>=0.6.0' 'python-asdf_coordinates_schemas>=0.4.0')
