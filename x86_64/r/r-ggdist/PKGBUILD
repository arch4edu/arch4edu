...
check() {
  cd "$_pkgname/tests"
  # Upstream SVG snapshots use a different vdiffr graphics engine.
  # CRAN mode keeps rendering and numerical checks, but skips SVG comparisons.
  R_LIBS="$srcdir/build" NOT_CRAN=false Rscript --vanilla testthat.R
}
