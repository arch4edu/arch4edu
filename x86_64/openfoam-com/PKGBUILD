...
build() {
  ...
  # bugfix OpenFOAM-v2212
  sed -i 's!#include "CGAL/Robust_circumcenter_filtered_traits_3.h"!#include "CGAL/Robust_weighted_circumcenter_filtered_traits_3.h"!g' $projectDir/applications/utilities/mesh/generation/foamyMesh/conformalVoronoiMesh/conformalVoronoiMesh/CGALTriangulation3DKernel.H
