...
#             'python-pytest-xdist'
              'python-pytest-doctestplus')   # astropy, matplotlib, scipy already in makedepends; header in dust_extinction/conftest.py
source=("https://files.pythonhosted.org/packages/source/${_pyname:0:1}/${_pyname}/${_pyname}-${pkgver}.tar.gz")
md5sums=('314dd8fef86316ea78d59d0898b7103d')
