...
options=(!strip)
source=(
  "riscv64-gnu-toolchain-elf-bin-2025.11.27-riscv64-elf-ubuntu-24.04-gcc.tar.xz::https://github.com/riscv-collab/riscv-gnu-toolchain/releases/download/2025.11.27/riscv64-elf-ubuntu-24.04-gcc.tar.xz"
)
sha512sums=(
