...
# Contributor: Alex Maystrenko <alexeytech@gmail.com>
...
makedepends=('python-setuptools' 'python-sphinx' 'python-mock' 'openmpi' 'gdal' 'glew' 'unixodbc' 'tk' 'ffmpeg' 'jsoncpp' 'gcc-libs')
