...
source=(
  "python-transformers-$pkgver.tar.gz"::"https://github.com/huggingface/transformers/archive/refs/tags/$pkgver.tar.gz"
)
sha256sums=('1a13108dffbfde8e9a2186a14f2be8a20b015884554d59270cbf978e7c037998')
